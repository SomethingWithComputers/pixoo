...
Most of the methods available in the Pixoo library are support- except currently for loading a local image (for obvious
reasons).
...
These are the currently supported REST calls
